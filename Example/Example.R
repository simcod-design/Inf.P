...
n.att<- c(3)
n.item<- c(10,15,20,25,30)
n.sample <- c(30,50,100,150,200,250,300,350,400,450,500,1000)
...
convert_list_to_char <- function(x) {
  if (is.list(x)) {
...
results[,] <- lapply(results, convert_list_to_char)
